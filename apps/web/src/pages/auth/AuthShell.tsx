  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-10">
        ...
        <div>
          <p className="text-3xl font-light" style={{ fontFamily: fonts.display, color: colors.ink }}>
            Dispensa
          </p>
          <p className="text-xs" style={{ color: colors.inkMuted }}>la cucina di famiglia</p>
        </div>
      </div>
